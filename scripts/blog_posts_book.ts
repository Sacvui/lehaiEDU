...
export const book_intro = [
    {
        ...
        categorySlug: 'book-intern-to-ceo',
        coverImage: '/blog/book_cover_ncskit_final.png', // Premium 3D Cover with NCSKIT badge
        featured: true,
        readingTime: 7,
        tags: ['Book Project', 'Executive Education', 'Leadership', 'Strategic Management'],
        body: [
            {
                _type: 'block',
                style: 'h2',
                children: [{ _type: 'span', text: 'The Vision: Why "Nursery Rhymes"?' }],
            },
            {
                _type: 'block',
                style: 'normal',
                children: [{ _type: 'span', text: 'In the complex world of business, complexity is often a guise for confusion. The most profound truths are often the simplest—like nursery rhymes we learn as children. They stick with us. They guide us.\n\n"300 Nursery Rhymes" is not a collection of simplistic tips. It is a distillation of 13 years of intense operational and strategic experience. It is an attempt to codify the unspoken rules of professional advancement, from the granular details of execution to the high-level orchestration of organizational strategy.' }],
            },
            {
                _type: 'block',
                style: 'h2',
                children: [{ _type: 'span', text: 'The Strategic Roadmap' }],
            },
            {
                _type: 'block',
                style: 'normal',
            ...
            {
                _type: 'image',
                localPath: '/blog/book_mockup_stack_ncskit_final.png',
                alt: 'Book Stack Mockup',
                caption: 'Official Release: "300 Nursery Rhymes: From Intern to CEO" - Verified by NCSKIT.ORG'
            },
            {
                _type: 'block',
                style: 'normal',
